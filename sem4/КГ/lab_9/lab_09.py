...
from PyQt5.QtCore import Qt, QPoint, QTime, QEventLoop, QCoreApplication
import copy
...
def isConvex(edges):
    ...
    for i in range(2, len(edges) - 1):
        ...
        # если знак предыдущей координаты не совпадает, то многоугольник невыпуклый
        if curr != prev:
            flag = 0

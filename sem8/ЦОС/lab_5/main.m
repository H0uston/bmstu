...
figure(1)
plot(t,x0,t,x1,t,x2,'b');
title('Original signals');
legend('Without noise','Impulsive noise','Gaussian noise');

figure(2)
plot(t,x0,t,filtfilt(B,A,x1),t,filtfilt(B,A,x2),'g');
title('Recursive Butterworth filtering');
legend('Without noise','Impulsive noise','Gaussian noise');

figure(3)
plot(t,x0,t,x1-filtfilt(G,1,x1),t,x2-filtfilt(G,1,x2),'y');
title('Non-recursive Gaussian filtering');
legend('Without noise','Impulsive noise','Gaussian noise');

figure(4)
plot(t,x0,t,x1-filtfilt(BB,1,x1),t,x2-filtfilt(BB,1,x2),'r');

...
def transposition(values):
    ...
    values[65], values[67] = values[67], values[65]
    values[66], values[67] = values[67], values[66]
    values[67], values[69] = values[69], values[67]
    values[68], values[69] = values[69], values[68]

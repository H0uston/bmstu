...
struct sembuf start_reader[5]	= {{RR, 1, 0}, {SB,  0, 0}, {WR,  0, 0}, {RI,  1, 0}, {RR, -1, 0}},
	      //увеличиваем семафор ждущих чит., ждем освобождения ресурса, ждем пока отработают писатели, увеличиваем семафор активных чит., уменьшаем семафор ждущих чит.
              stop_reader[1]	= {{RI, -1, 0}},
	      //уменьшаем семафор активных чит.
		  one_up[1]={{SB,1,0}},
	      
	      /*start_writer_w[1]	= {{WR,  1, 0}},
	      //увеличиваем семафор ждущих пис.
	      start_writer_s[4] = {{RI,  0, 0}, {SB,  0, 0}, {SB,  1, 0}, {WR, -1, 0}},
	      //ждем пока отработают читатели, ждем освобождения ресурса, захватываем ресурс, уменьшаем семафор ждущих пис.*/

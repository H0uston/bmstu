    ...
    if way == '-e':
        ...
        for byte in data:
            ...
            if 0 < len(temp) < 16:
                ...
                crypted_part = encrypt(temp, key)
                crypted_data.extend(crypted_part)
                crypted_data.append(empty_spaces)
                print(empty_spaces)
        ...
        for i in range(len(data)):
            ...
            byte = data[i]
            temp.append(byte)
            if len(temp) == 16 and i == len(data) - 2:
                empty_spaces = data[i + 1]
                print(empty_spaces)
                decrypted_part = decrypt(temp, key)
                decrypted_data.extend(decrypted_part[:len(decrypted_part) - empty_spaces])
                del temp[:]
            elif len(temp) == 16:
                decrypted_part = decrypt(temp, key)
            ...
            #    decrypted_data.extend(temp[:empty_spaces])
